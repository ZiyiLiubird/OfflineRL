...
class AlgoTrainer(BaseAlgo):
    ...
    def _cql_update(self, batch_data, offbatch=None, model_batch=None):
        ...
        # calculate q value from model dataset
        ...
        q1_penalty = (torch.logsumexp(sampled_q1, dim=0) - off_q1) * self.args['base_beta']
        q2_penalty = (torch.logsumexp(sampled_q2, dim=0) - off_q2) * self.args['base_beta']
